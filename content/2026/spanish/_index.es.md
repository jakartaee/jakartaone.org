...
tagline: "16 de octubre del 2026"
...
{{< grid/section-container id="registration" containerClass="backdrop padding-bottom-40 padding-top-40" >}}
  {{< grid/div class="container" isMarkdown="false" >}}
    {{< events/registration event="spanish" year="2026" title="Sobre el evento" >}}
...
para la nube. Organizado por los Grupos de Usuarios de Java de El Salvador, Guatemala,
República Dominicana, Panamá y más.
    {{</ events/registration >}}
  {{</ grid/div >}}
{{</ grid/section-container >}}

<!-- Commented out until sponsor data is available
{{< grid/section-container id="sponsors" class="text-center margin-top-40">}}
  {{< events/sponsors event="spanish" year="2026" title="Comunidades amigas" displayBecomeSponsor="false">}}
{{</ grid/section-container >}}
-->

<!-- Commented out until agenda data is available
{{< grid/section-container class="alt" id="plan-of-the-day" containerClass="backdrop padding-bottom-40 padding-top-40" >}}
  {{< grid/div class="container" isMarkdown="false">}}
    {{< events/agenda event="spanish" year="2026" >}}
  {{</ grid/div >}}
{{</ grid/section-container >}}
{{< bootstrap/modal id="eclipsefdn-modal-event-session" >}}
-->

<!-- Commented out until speaker data is available
{{< grid/section-container id="speakers" class="speaker-container padding-bottom-40 padding-top-40 text-center">}}
  {{< grid/div class="padding-top-40" isMarkdown="false">}}
    {{< events/user_display event="spanish" year="2026" source="speakers" subpage="speakers" useCarousel="false" imageRoot="/images/speakers/" title="Conferencistas" headerClass="text-center" />}}
  {{</ grid/div >}}
{{</ grid/section-container >}}
-->

<!-- Commented out until committee data is available
{{< events/program-committee event="spanish" year="2026" source="committee" subpage="program-committee" title="Comité del Programa" useCarousel="false" >}}
