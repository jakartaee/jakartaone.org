...
{{< grid/section-container id="registration" containerClass="backdrop padding-bottom-40 padding-top-40" >}}
  {{< grid/div class="container" isMarkdown="false" >}}
    {{< events/registration event="japan2020" >}}
日本で最初のJakartaOne Livestreamは、皆様のおかげにより、大成功で終えることができました！  

コミュニティの結集により、実現できましたこと、まことに感謝いたします。
    {{</ events/registration >}}
  {{</ grid/div >}}
...
{{< grid/section-container >}}
  {{< grid/div class="padding-top-40" isMarkdown="false">}}
    {{< events/user_display event="japan2020" source="committee" subpage="program-committee" >}}
私達は、Eclipse Foundation と独立した Jakarta&reg; EE コミュニティのボランティアスタッフです。プログラム委員会は、クラウドネイティブJavaを推進する、JakartaOne Livestream Event のイベント内容を企画・構成しています。
    {{</ events/user_display >}}
  {{</ grid/div >}}
{{</ grid/section-container >}}
